...
class TestLikelihood(unittest.TestCase):
    def setUp(self):
        ...
        self.binom_data, self.binom_comparedata = np.random.binomial(
            20, 0.1, 20
        ), np.random.binomial(20, 0.1, 20)
        self.do_print = True

    def test_logLikelihood(self):
        l_normal = spotpy.likelihoods.logLikelihood(
            self.normal_data, self.normal_comparedata
        )
        self.assertGreaterEqual(np.abs(l_normal), 900)
        self.assertEqual(type(float(l_normal)), type(float(1)))
        if self.do_print:
            print("logLikelihood: " + str(l_normal))

        l_binom = spotpy.likelihoods.logLikelihood(
            self.binom_data, self.binom_comparedata
        )
        self.assertGreaterEqual(np.abs(l_binom), 900)
        self.assertEqual(type(float(l_binom)), type(float(1)))
        if self.do_print:
            print("logLikelihood: " + str(l_binom))

    def test_gaussianLikelihoodMeasErrorOut(self):
        l_normal = spotpy.likelihoods.gaussianLikelihoodMeasErrorOut(
            self.normal_data, self.normal_comparedata
        )
    ...
    def test_gaussianLikelihoodHomoHeteroDataError(self):
        l_normal = spotpy.likelihoods.gaussianLikelihoodHomoHeteroDataError(
            self.normal_data, self.normal_comparedata
        )
        ...
        l_binom = spotpy.likelihoods.gaussianLikelihoodHomoHeteroDataError(
            self.binom_data, self.binom_comparedata
        )
    ...
    def test_LikelihoodAR1NoC(self):
        ...
        l_list.append(
            spotpy.likelihoods.LikelihoodAR1NoC(
                self.normal_data,
        ...
        l_list.append(
            spotpy.likelihoods.LikelihoodAR1NoC(self.binom_data, self.binom_data)
        )
    ...
    def test_LikelihoodAR1WithC(self):
        ...
        try:
            l_normal_list.append(
                spotpy.likelihoods.LikelihoodAR1WithC(
                    self.normal_data, self.normal_comparedata, params=([], [])
                )
            )
        except LikelihoodError as e:
    ...
    def test_generalizedLikelihoodFunction(self):
        size = 1000
        data, comparedata = np.random.normal(1500, 2530, size), np.random.normal(
            355, 25, size
        )
        ...
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data,
                comparedata,
                params=([-0.09, 1, 0.5, 0.567, 0.98, 57.32], param_list),
            )
        )
        ...
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data, comparedata, params=([2, 1, 0.5, 0.567, 0.98, 57.32], param_list)
            )
        )
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data,
                comparedata,
                params=([-0.09, 11, 0.5, 0.567, 0.98, 57.32], param_list),
            )
        )
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data,
                comparedata,
                params=([-0.09, 1, 1.5, 0.567, 0.98, 57.32], param_list),
            )
        )
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data,
                comparedata,
                params=([-0.09, 1, 0.5, 1.567, 0.98, 57.32], param_list),
            )
        )
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data,
                comparedata,
                params=([-0.09, 1, 0.5, 0.567, 2.98, 57.32], param_list),
            )
        )
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data,
                comparedata,
                params=([-0.09, 1, 0.5, 0.567, 0.98, 101], param_list),
            )
        )
        l_normal_list.append(
            spotpy.likelihoods.generalizedLikelihoodFunction(
                data,
                comparedata,
                params=([-0.09, 0.0, 0.5, 0.567, 0.98, 101], param_list),
            )
        )
    ...
    def test_LaplacianLikelihood(self):
        l_normal = spotpy.likelihoods.LaplacianLikelihood(
            self.normal_data, self.normal_comparedata
        )
        self.assertNotEqual(None, l_normal)
        self.assertEqual(type(float(l_normal)), type(float(1)))
        ...
        l_binom = spotpy.likelihoods.LaplacianLikelihood(
            self.binom_data, self.binom_comparedata
        )
        self.assertNotEqual(None, l_normal)
        self.assertEqual(type(float(l_binom)), type(float(1)))
    ...
    def test_SkewedStudentLikelihoodHomoscedastic(self):
        l_normal = spotpy.likelihoods.SkewedStudentLikelihoodHomoscedastic(
            self.normal_data, self.normal_comparedata
        )
        ...
        l_binom = spotpy.likelihoods.SkewedStudentLikelihoodHomoscedastic(
            self.binom_data, self.binom_comparedata
        )
    ...
    def test_SkewedStudentLikelihoodHeteroscedastic(self):
        ...
        l_normal_list.append(
            spotpy.likelihoods.SkewedStudentLikelihoodHeteroscedastic(
                self.normal_data,
                self.normal_comparedata,
    ...
    def test_SkewedStudentLikelihoodHeteroscedasticAdvancedARModel(self):
        ...
        for l_normal in l_normal_list:
            ...
            if self.do_print:
                print(
                    "SkewedStudentLikelihoodHeteroscedasticAdvancedARModel: "
                    + str(l_normal)
                )
        ...
        if self.do_print:
            print(
                "SkewedStudentLikelihoodHeteroscedasticAdvancedARModel: " + str(l_binom)
            )

    def test_NoisyABCGaussianLikelihood(self):
        l_normal = spotpy.likelihoods.NoisyABCGaussianLikelihood(
            self.normal_data, self.normal_comparedata
        )
        self.assertNotEqual(None, l_normal)
        self.assertEqual(type(float(l_normal)), type(float(1)))
        ...
        l_binom = spotpy.likelihoods.NoisyABCGaussianLikelihood(
            self.binom_data, self.binom_data, measerror=[0.0]
        )
        self.assertNotEqual(None, l_binom)
        self.assertEqual(type(float(l_binom)), type(float(1)))
        if self.do_print:
    ...
    def test_ABCBoxcarLikelihood(self):
        l_normal = spotpy.likelihoods.ABCBoxcarLikelihood(
            self.normal_data, self.normal_comparedata
        )
        self.assertNotEqual(None, l_normal)
        ...
        l_binom = spotpy.likelihoods.ABCBoxcarLikelihood(
            self.binom_data, self.binom_comparedata
        )
        self.assertNotEqual(None, l_binom)
    ...
    def test_LimitsOfAcceptability(self):
        l_normal = spotpy.likelihoods.LimitsOfAcceptability(
            self.normal_data, self.normal_comparedata
        )
        self.assertEqual(12, l_normal)
        self.assertNotEqual(None, l_normal)
        self.assertEqual(type(int(l_normal)), type(int(1)))
        if self.do_print:
            print("LimitsOfAcceptability: " + str(l_normal))

        l_binom = spotpy.likelihoods.LimitsOfAcceptability(
            self.binom_data, self.binom_comparedata
        )
        self.assertEqual(5, l_binom)
        self.assertNotEqual(None, l_binom)
        self.assertEqual(type(int(l_binom)), type(int(1)))
        if self.do_print:
            print("LimitsOfAcceptability: " + str(l_binom))

    def test_InverseErrorVarianceShapingFactor(self):
        l_normal = spotpy.likelihoods.InverseErrorVarianceShapingFactor(
            self.normal_data, self.normal_comparedata
        )
        ...
        l_binom = spotpy.likelihoods.InverseErrorVarianceShapingFactor(
            self.binom_data, self.binom_comparedata
        )
    ...
    def test_ExponentialTransformErrVarShapingFactor(self):
        ...
        l_gauss = spotpy.likelihoods.ExponentialTransformErrVarShapingFactor(
            self.normal_data, self.normal_comparedata
        )
        self.assertGreaterEqual(-30, l_gauss)
        self.assertEqual(type(float(l_gauss)), type(float(1)))
        if self.do_print:
    ...
    def test_NashSutcliffeEfficiencyShapingFactor(self):
        l_normal_list = []
        l_normal_list.append(
            spotpy.likelihoods.NashSutcliffeEfficiencyShapingFactor(
                self.normal_data, self.normal_comparedata
            )
        )
        ...
        try:
            l_normal_list.append(
                spotpy.likelihoods.NashSutcliffeEfficiencyShapingFactor([1], [])
            )
        except LikelihoodError as e:
            print("Likelihood Error occurred " + str(e))
    ...
    def test_sumOfAbsoluteErrorResiduals(self):
        l_normal = spotpy.likelihoods.sumOfAbsoluteErrorResiduals(
            self.normal_data, self.normal_comparedata
        )
        ...
        l_binom = spotpy.likelihoods.sumOfAbsoluteErrorResiduals(
            self.binom_data, self.binom_comparedata
        )
